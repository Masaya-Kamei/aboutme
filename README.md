...
- 九州大学 工学部 電気情報工学科 計算機工学コース 卒業
  - コンピュータサイエンスの基礎を学習。
  - 研究は、圧力センサを使った介護動作の定量化。
- 42tokyo
  - 講師不在で教科書がない現場に近い環境で課題をこなす。
  - 低レイヤの仕組みを解明しつつ、実装力を鍛えた。
  - 主にCやC++で、シェルやwebサーバー、webアプリなど作成。
...
- 4週間に及ぶ入学試験Piscine を受験して合格。
- 講師不在で教科書がないという現場に近い環境で課題をこなす。
